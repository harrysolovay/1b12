;(() => {
  ...
  e.id = 492,
    ...
    e.modules = {
      ...
      6623: (e, r, t) => {
        "use strict"
        t.r(r),
          t.d(r, { GlobalError: () => i.a, __next_app__: () => p, pages: () => u, routeModule: () => h, tree: () => a })
        var n = t(5239), s = t(8088), o = t(8170), i = t.n(o), d = t(893), l = {}
        for (let e in d) {
        ...
        let a = {
            children: ["", {
              ...
              layout: [
                () => Promise.resolve().then(t.bind(t, 8014)),
                "/Users/harrysolovay/Desktop/1b1b1b1b/app/layout.tsx",
              ],
              "not-found": [
                () => Promise.resolve().then(t.t.bind(t, 7398, 23)),
                "next/dist/client/components/not-found-error",
  ...
  r.C(e)
  var t = (e) => r(r.s = e), n = r.X(0, [447, 825], () => t(6623))
  module.exports = n
})()
