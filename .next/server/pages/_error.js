...
;(() => {
  ...
  e.id = 731,
    ...
    e.modules = {
      ...
      413: (e, t, r) => {
        ...
        var n = r(3885), o = r(237), a = r(1413), i = r(8548), l = r.n(i), u = r(9380), s = r.n(u), d = r(6631)
        let c = (0, a.M)(d, "default"),
          ...
          x = new n.PagesRouteModule({
            definition: { kind: o.A.PAGES, page: "/_error", pathname: "/_error", bundlePath: "", filename: "" },
      ...
      6631: (e, t, r) => {
        ...
        function u(e) {
          let t, { req: n, res: o, err: a } = e, i = o && o.statusCode ? o.statusCode : a ? a.statusCode : 404
          if (n) {
            let { getRequestMeta: e } = r(5124), o = e(n, "initURL")
      ...
      9380: (e, t, r) => {
        ...
        let n = r(7020), o = r(8732), a = n._(r(2015)), i = r(6370)
        async function l(e) {
      ...
      9722: (e, t, r) => {
        ...
        function h(e, t) {
          ...
          return e.reduce(p, []).reverse().concat(c(r).reverse()).filter(function() {
            ...
            let n = e.key || t
            if (
              process.env.__NEXT_OPTIMIZE_FONTS && !r && "link" === e.type && e.props.href
        ...
        let g = function(e) {
          let { children: t } = e, r = (0, i.useContext)(u.AmpStateContext), n = (0, i.useContext)(s.HeadManagerContext)
  ...
  t.C(e)
  var r = (e) => t(t.s = e), n = t.X(0, [548], () => r(413))
  module.exports = n
})()
